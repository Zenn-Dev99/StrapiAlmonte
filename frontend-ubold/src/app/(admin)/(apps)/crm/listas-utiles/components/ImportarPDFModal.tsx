...
import { TbUpload, TbFilePdf } from 'react-icons/tb'
...
type ImportarPDFModalProps = {
  show: boolean
  onHide: () => void
}

export default function ImportarPDFModal({ show, onHide }: ImportarPDFModalProps) {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const response = await fetch('/api/crm/listas-utiles/import-pdf', {
        method: 'POST',
        body: formData,
      })
        ...
        {!preview ? (
          <>
            <Alert variant="info" className="mb-3">
              <strong>Importación con IA</strong>
              <br />
              Suba un PDF con la lista de útiles. Utilizaremos Claude API para extraer automáticamente los materiales.
            </Alert>
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Text className="text-muted">
                El PDF será procesado con IA para extraer automáticamente los materiales.
              </Form.Text>
            </Form.Group>
            ...
            {loading && (
              <div className="mb-3">
                ...
                <small className="text-muted">
                  Extrayendo texto del PDF y procesando con Claude API...
                </small>
              </div>
            )}
          </>
          ...
          <>
            <Alert variant="success" className="mb-3">
              <strong>¡PDF procesado exitosamente!</strong>
              <br />
              Se encontraron {editableMaterials.length} material(es) usando IA. Revise y edite si es necesario antes de guardar.
            </Alert>
      ...
      <Modal.Footer>
        ...
        {!preview ? (
          ...
          >
            ...
            {loading ? 'Procesando con IA...' : 'Procesar PDF'}
          </Button>
        ) : (
          <Button
            variant="success"
