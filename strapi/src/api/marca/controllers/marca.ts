...
export default factories.createCoreController('api::marca.marca' as any, ({ strapi }) => ({
  async update(ctx: any) {
    ...
    if (isNumericId(rawId)) {
      ...
      const found = await strapi.entityService.findMany('api::marca.marca' as any, {
    ...
    const entity = await strapi.entityService.update('api::marca.marca' as any, identifier, {
      data,
    });
  ...
  async delete(ctx: any) {
    ...
    const entity = await strapi.entityService.delete('api::marca.marca' as any, identifier);
